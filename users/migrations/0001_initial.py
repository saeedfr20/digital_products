# Generated by Django 5.2 on 2026-06-29 12:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.BigIntegerField(error_messages={'unique': 'A user with this mobile number already exists.'}, unique=True, validators=[django.core.validators.RegexValidator('^989[0-3,9]\\d{8}$', 'Enter a valid phone number.', 'invalid')], verbose_name='phone number')),
